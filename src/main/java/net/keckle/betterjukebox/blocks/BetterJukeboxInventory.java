...
public interface BetterJukeboxInventory extends Inventory {

    /**
     * Creates an inventory from the item list.
     */
    static BetterJukeboxInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     */
    static BetterJukeboxInventory ofSize(int size) {
